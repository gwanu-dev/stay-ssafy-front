...
.mainhead{
    ...
    min-height: 35rem;
    padding: 15rem 0;
    background: linear-gradient(to bottom, rgba(0, 0, 0, 0.1) 0%, rgba(255, 255, 255, 0.6) 75%, #ffffff 100%), url("src/assets/img/bg-mainhead.jpg");
...
.mytripplan{
    padding-top: 10rem;
    background: linear-gradient(to bottom, #ffffff 0%, rgba(255, 255, 255, 0.9) 75%, rgba(255, 255, 255, 0.8) 100%);
}

.hot-place{
  padding-top: 10rem;
  background: linear-gradient(to bottom, #ffffff 0%, rgba(182, 182, 182, 0.9) 75%, rgba(177, 177, 177, 0.8) 100%);
}
